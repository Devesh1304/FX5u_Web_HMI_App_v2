...
{
    public class PowerPointTableModel : PointTableModelBase
    {
        ...
        {
            _slmpService.SetHeartbeatValue(10); // Set a unique value for this screen
        ...
        {
            { nameof(PositionWrite1), "D918" },

        };
        protected override Dictionary<string, string> WritableInt16Map => new()
        {
            { nameof(SpeedWrite1), "D920" }, { nameof(AccWrite1), "D921" }, { nameof(DeccWrite1), "D922" }, { nameof(DwellTimeWrite1), "D923" }, { nameof(AuxWrite1), "D924" }, { nameof(MWrite1), "D925" },
            ...
            { nameof(MaxReverseTorque), "D3998" },          
             { nameof(PointControlRegisterD5), "D5" },
        ...
        public PowerPointTableModel(ILogger<PowerPointTableModel> logger, ISLMPService slmpService)
